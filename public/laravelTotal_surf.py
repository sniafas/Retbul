...
if __name__ == '__main__':
	...
	for trainIm in qimg:
		...
		#save_path = "%s/surf_logs/%s/" % (timestampFolder, str(trainIm[:11]) )
		#print save_path
		...
		#cv2.imwrite(save_path + '/surf_keypoints2.jpg',img2Res)
		...
		if len(kp_pairs) > 4:
			...
			try:
				...
				cv2.imwrite(timestampFolder + '/' + trainIm +  '_surf_match.jpg', img3)
				n+=1
